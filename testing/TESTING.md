...
**Before**
![Screenshot of the HTML5 validator results before testing](html-validator-before.png)

**After**
![Screenshot of the HTML5 validator results after testing](html-validator-after.png)

### CSS3 Validation

**Before**
![Screenshot of the CSS3 validator results before testing](css-validator-before.png)

**After**
![Screenshot of the CSS3 validator results after testing](css-validator-after.png)
...
![Screenshot of the responsiveness tests for mobile](mobile-responsiveness.png)

### Tablets (768px x 614px)
![Screenshot of the responsiveness tests for tablets](tablet-responsiveness.png)

### Laptops and larger screens (1024px x 614px)
![Screenshot of the responsiveness tests for laptops](laptop-responsiveness.png)
...
![Screenshot show browser compatibility for Chrome](chrome-browser-compatibility.png)

### Firefox

![Screenshot show browser compatibility for Firefox](firefox-browser-compatibility.png)

### Microsoft Edge

![Screenshot showing browser compatibility for Microsoft Edge](edge-browser-compatibility.png)

## Form Validation Testing

![Screenshot showing form validation testing](form-validation-testing.png)
...
**Evidence:**
![Screenshot showing user story met evidence](firefox-browser-compatibility.png)
...
**Evidence:**
![Screenshot showing user story met evidence](d&i-importance.png)
...
**Evidence:**
![Screenshot showing user story met evidence](real-world-examples.png)
...
**Evidence:**
![Screenshot showing user story met evidence](other-resources-evidence.png)
...
**Evidence:**
![Screenshot showing user story met evidence](summary-evidence.png)
